      ...
      "properties": {
        ...
        "results": {
          ...
          "properties": {
            ...
            "matches": {
              "description": "How many objects matched, counted only far enough to show whether more match than one call deletes. A value above ` + "`" + `limit` + "`" + ` means more objects match, so call again.",
              "type": "number",
              "format": "int64",
              "x-omitempty": false
            },
